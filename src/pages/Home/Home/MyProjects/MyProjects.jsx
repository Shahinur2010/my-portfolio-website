...
const MyProjects = () => {
    ...
    return (
        <div className="p-2">
            <h2 className="font-bold mt-12 text-center text-3xl border-double border-4 border-blue-500 rounded-lg bg-blue-200">Projects</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-auto">
                <div className="mx-auto relative max-w-full h-72 overflow-hidden rounded-lg my-12">
                    <div className="h-max w-full transition-transform duration-[3000ms] ease-linear transform translate-y-0 hover:-translate-y-[calc(100%-18rem)] rounded-lg">
                        <figure className="px-10 pt-10">
                            <img src={ss1} alt="Shoes" className="rounded-xl h-48 w-full" />
                        </figure>
